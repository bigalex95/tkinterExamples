...
with pyvirtualcam.Camera(width, height, fps, print_fps=True) as cam:
    ...
    while True:
        ...
        # 1. A color gradient.
        gradient = get_gradation_3d(
            width, height, (0, 0, 192), ((i*2) % 255, 255, 64), (True, False, False))
        ...
        for i_bit, bit in enumerate(bits):
            ...
            frame[:bit_size, i_bit*bit_size:i_bit *
                  bit_size+bit_size, :3] = bit_color
